...
if (isset($_POST['id'])) {
	...
	$urunler=$sorgu->fetch(PDO::FETCH_ASSOC);
}
$id = $_POST['id'];
?>
<!doctype html>
<html lang="tr">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ürün Ekle - <?=$ayar['site_title']?></title>
...
<script>Swal.fire("Ürün ", " Başarıyla Eklendi", "success"); </script>
<?php } ?>


<?php 
if (@$_GET['durum']=="Eklenmedi") { ?>
<script>Swal.fire("Ürün ", "Eklenmedi !", "error"); </script>
<?php } ?>

  <?php 
if (@$_GET['durum']=="Guncellendi") { ?>
<script>Swal.fire("Ürün ", " Başarıyla Güncellendi", "success"); </script>
<?php } ?>


<?php 
if (@$_GET['durum']=="Guncellenmedi") { ?>
<script>Swal.fire("Ürün ", "Güncellenmedi !", "error"); </script>
<?php } ?>
...
<?php include("inc/sol-menu.php");?>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="urun-listele.php">Ürün Listele</a></li>
                        ...
                        <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <?php if($_POST['id']!=''){?>
                                      <input type="hidden" value="../urun-listele.php" name="link">
                                      <?php } else {?>
                                      <input type="hidden" value="../urun-ekle.php" name="link">
                                      <?php }?>
                                         <input type="hidden" value="<?=$_POST['id']?>" name="id">
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Ürün Sirası</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="sira" value="<?=$urunler['sira']?>" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-search-input" class="col-md-2 col-form-label">Ürün Adı </label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="adi" value="<?=$urunler['adi']?>" id="example-search-input">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-email-input" class="col-md-2 col-form-label">Ürün Ön Açıklama </label>
                                            <div class="col-md-10">
                                              <textarea required class="form-control" name="onaciklama" rows="5"><?=$urunler['onaciklama']?></textarea>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label"> Ürün Resim </label>
                                            <?php if($_POST['id']!=''){?>
                                            <div class=" col-md-2"><img src="../resimler/<?=$urunler['resim']?>" width="100%"></div>
                                            <div class="col-md-8">
                                            ...
                                            <?php }?>
                                             ...
                                             <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label"> Ürün Açıklama </label>
                                            
                                            <div class="col-md-10">
                                                     <textarea  class="ckeditor" name="aciklama"  rows="10"><?=$urunler['aciklama']?></textarea>
                                            </div>
                                        </div>
         ...
         <div class="row" id="resimler">
                            	...
                            	<?php
									...
									$iddd=$_POST['id'];
									if($_POST['id']!=''){
										$cek = $db->query("SELECT * FROM urun_img WHERE urun_id = '$id' and tur='urunler' order by id asc", PDO::FETCH_ASSOC);
										if($cek->rowCount()){
											foreach( $cek as $c ){
...
<div id="queue"></div>
                       ...
                       <?php if($_POST['id']==''){?>
                         <button type="submit" name="urun-ekle" class="btn btn-primary waves-effect waves-light">
                                                <i class="ri-check-line align-middle me-2"></i> Yeni Ürün Ekle
                                            </button>
                                            <?php } else {?>
                                              <button type="submit" name="urun-guncelle" class="btn btn-primary waves-effect waves-light">
                                                <i class="ri-check-line align-middle me-2"></i>  Ürün Güncelle
                                            </button>
                                            <?php }?>
